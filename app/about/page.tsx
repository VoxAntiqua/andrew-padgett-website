      ...
      <div className="container flex flex-wrap gap-6 h-[calc(100vh-15rem)]">
        ...
        <div className="flex-1 flex flex-col justify-center h-full gap-4 relative mr-8">
          <div className="container h-full max-h-full overflow-y-auto p-4">
            ...
            <p className="mt-4">
              Andrew has been a featured soloist on a number of recently-released recordings, including <em><a href="https://www.amazon.com/Fortuna-Antiqua-Ultra-Medieval-Fortune/dp/B09RJHPJ2N" className="text-blue-700 hover:underline">Fortuna Antiqua et Ultra</a></em> and <em><a href="https://concordiandawn.com/release/medieval-song-from-aristotle-to-opera/" className="text-blue-700 hover:underline">Medieval Song from Aristotle to Opera</a></em> with Concordian Dawn, and <em><a href="https://www.saintthomaschurch.org/product/the-music-of-gerre-hancock/" className="text-blue-700 hover:underline">The Music of Gerre Hancock</a></em> with The Saint Thomas Choir of Men and Boys.
            </p>
            <p className="mt-4">
              Andrew holds a B.S. in physics, an M.M. in voice from UC Santa Barbara, and an M.M. in Early Music, Oratorio, and Chamber Ensemble from Yale University&rsquo;s Institute of Sacred Music. After several years in New York City, as a member of the internationally-acclaimed Saint Thomas Choir of Men and Boys, he now lives in the suburbs of Boston with his wife and son, where he frequently sings with Emmanuel Music on their long-running Bach Cantata Series, under the direction of Ryan Turner. In his free time, Andrew enjoys <a href="https://www.instagram.com/vox.antiqua.painting/" className="text-blue-700 hover:underline">miniature painting</a> and homebrewing.
            </p>
            <p className="mt-4">
              <a
