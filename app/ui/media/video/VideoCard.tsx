...
const VideoCard: React.FC<VideoCardProps> = ({ video }) => {
  return (
    <div className="bg-white shadow-md overflow-hidden flex flex-col w-full max-w-sm">
      ...
      <div className="p-4 flex-1">
        ...
        {video.composerOrSubtitle ? (
          <h4 className="mt-0">{video.composerOrSubtitle}</h4>
        ) : null}
        <p className="text-sm text-slate-600 my-1">
          recorded {video.monthYear} with{' '}
          <a
            href={video.ensemble.url}
            target="_blank"
