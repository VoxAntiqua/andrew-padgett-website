      ...
      <div className="flex flex-col md:flex-row gap-12">
        <div className="flex-1 space-y-8">
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>Colin Clarke, <a href="https://fanfarearchive.com/ntbm/articles/thompson-clarke.html" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Fanfare Archive</a></span>
          </p>
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>Edward A Kliszus, <a href="https://openingnight.online/american-classical-orchestra-j-s-bachs-st-john-passion/" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Opening Night Reviews</a></span>
          </p>
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>Amelia LeClair, <a href="https://www.classical-scene.com/2024/06/07/carrying-bach/" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Boston Music Intelligencer</a></span>
          </p>

          <p>
            &quot;Kyle Stegall, tenor, Andrew Padgett, bass, and John Taylor Ward, bass, were particularly outstanding.&quot;
            <br />
            <span className='block text-right py-3'>David Griesinger, <a href="https://www.classical-scene.com/2012/11/13/wonder-suzuki/" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Boston Music Intelligencer</a></span>
          </p>
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>Ken Herman, <a href="https://sandiegostory.com/bach-collegium-san-diegos-transcendent-el-mesias-in-point-loma/" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">San Diego Story</a></span>
          </p>
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>Malcolm Riley, <a href="https://www.gramophone.co.uk/review/hancock-choral-and-organ-music" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Gramophone</a></span>
          </p>
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>Gail Obenreder, <a href="https://www.broadstreetreview.com/reviews/piffaro-and-tenet-present-triomphi-petrarchs-triumphs-expressed-in-music-of-the-italian-renaissance" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Broad Street Review</a></span>
          </p>
        </div>
        ...
        <div className="flex-1 space-y-8">
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>David Truslove, <a href="https://operatoday.com/2021/06/the-music-of-celebrated-american-organist-choirmaster-gerre-hancock/" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Opera Today</a></span>
          </p>
          ...
          <p>&quot;Pilate, in Andrew Padgett&apos;s chilling, sinuous interpretation built up a kind of electrifying, edge-of-seat suspense, as though, despite knowing the story, one might still hope and wait with bated breath for a different outcome.&quot;
            <br/>
            <span className='block text-right py-3'>Maria-Cristina Necula, <a href="https://www.womanaroundtown.com/sections/playing-around/american-classical-orchestras-riveting-performance-of-bachs-st-john-passion/" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Woman Around Town</a></span>
          </p>
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>Geoffrey Williams, <a href="https://livingchurch.org/2021/05/10/a-masterly-tribute-to-gerre-hancock/" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">The Living Church</a></span>
          </p>
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>John Campbell, <a href="https://www.artsongupdate.org/Reviews/VWC/VWC19.htm" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Artsong Update</a></span>
          </p>
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>David Raymond, <a href="https://www.rochestercitynewspaper.com/rochester/classical-review-barbaras-venice/Content?oid=2890463" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Rochester City Newspaper</a></span>
          </p>
          ...
          <p>
            ...
            <br />
            <span className='block text-right py-3'>James Oestreich, <a href="https://www.nytimes.com/2014/03/06/arts/music/american-classical-orchestra-performs-handels-samson.html" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">NY Times</a></span>
          </p>

          <p>
            &quot;Andrew Padgett as Harapha gave a fine performance and excelled in the aria, &quot;Honour and arms scorn such a foe.&quot;&quot;
            <br />
            <span className='block text-right py-3'>Stan Metzger, <a href="https://seenandheard-international.com/2014/03/handels-samson-larger-life/" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Seen and Heard International</a></span>
          </p>
          ...
          &quot;Andrew Padgett set down his hurdy-gurdy to sing bass in liquor-themed works of Purcell and Antonio Cesti. The former&apos;s &quot;Bacchus is a Pow&apos;r Divine&quot; showcased Padgett&apos;s powerful baritone and impressive vocal range; a natural actor, he stumbled and hiccupped convincingly through the night&apos;s many entreaties on the importance of good wine without overdoing the gestures.&quot;
            <br />
            <span className='block text-right py-3'>Susan Hodge, <a href="https://www.musicweb-international.com/2013/10/hurdy-gurdy/" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">MusicWeb International</a></span>
          </p>
        </div>
      </div>
    </div>
