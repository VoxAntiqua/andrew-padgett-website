      ...
      <div className="flex flex-col md:flex-row gap-12">
        <div className="flex-1 space-y-8">
          ...
          <p>
            ...
            <br />
            <div className='text-right py-3'>Colin Clarke, <a href="https://fanfarearchive.com/ntbm/articles/thompson-clarke.html" target="_blank" rel="noopener noreferrer">Fanfare Archive</a></div>
          </p>
          ...
          <p>
            ...
            <br />
            <div className='text-right py-3'>David Griesinger, <a href="https://www.classical-scene.com/2012/11/13/wonder-suzuki/" target="_blank" rel="noopener noreferrer">Boston Music Intelligencer</a></div>
          </p>
          ...
          <p>
            ...
            <br />
            <div className='text-right py-3'>Ken Herman, <a href="https://sandiegostory.com/bach-collegium-san-diegos-transcendent-el-mesias-in-point-loma/" target="_blank" rel="noopener noreferrer">San Diego Story</a></div>
          </p>
        ...
        <div className="flex-1 space-y-8">
          ...
          <p>
            ...
            <br />
            <div className='text-right py-3'>Geoffrey Williams, <a href="https://livingchurch.org/2021/05/10/a-masterly-tribute-to-gerre-hancock/" target="_blank" rel="noopener noreferrer">The Living Church</a></div>
          </p>
          ...
          <p>
            ...
            <br />
            <div className='text-right py-3'>John Campbell, <a href="https://www.artsongupdate.org/Reviews/VWC/VWC19.htm" target="_blank" rel="noopener noreferrer">Artsong Update</a></div>
          </p>
          ...
          <p>
            ...
            <br />
            <div className='text-right py-3'>James Oestreich, <a href="https://www.nytimes.com/2014/03/06/arts/music/american-classical-orchestra-performs-handels-samson.html" target="_blank" rel="noopener noreferrer">NY Times</a></div>
          </p>

          <p>
            &quot;Andrew Padgett as Harapha gave a fine performance and excelled in the aria, &quot;Honour and arms scorn such a foe.&quot;&quot;
            <br />
            <div className='text-right py-3'>Stan Metzger, <a href="https://seenandheard-international.com/2014/03/handels-samson-larger-life/" target="_blank" rel="noopener noreferrer">Seen and Heard International</a></div>
          </p>
